package org.mycontrib.generic.jdbc.helper;
...
/* original code from ibatis 3.0.4 org.apache.ibatis.jdbc.ScriptRunner with RuntimeException instead of RuntimeSqlException
 * and with Helper method public static void  launchScript(DataSource ds,String sqlPathFromCP) */
...
public class ScriptRunner {
  ...
  public static void  launchSqlScript(DataSource ds,String sqlPathFromCP){
	  ...
	  try {
	    ...
	    Reader reader=new InputStreamReader(
	    		Thread.currentThread().getContextClassLoader().getResourceAsStream(sqlPathFromCP));
